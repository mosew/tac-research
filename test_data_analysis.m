...
global tau
badscales=[];
L2_errors = zeros(3,4,3,3,5);
Linf_errors = zeros(3,4,3,3,5);
AUC_errors = zeros(3,4,3,3,5);
peak_time_errors = zeros(3,4,3,3,5);
peak_height_errors = zeros(3,4,3,3,5);
actual_errors = cell(3,4,3,3,5);
full_deconvolved_BrACs = cell(3,4,3,3,5);
trained_parameters = cell(3,4,3,3,5);
